...
const Projects = () => {
  return (
    ...
    //   <Navbar />
    //   <section className="w-full flex flex-col items-center justify-center gap-5 pb-4 pt-28">
    //     <p className="text-black space font-bold text-2xl">
    //       MY <span className="text-[#FF6E6D]">WORKS</span> &{" "}
    //       <span className="text-[#A459FF]">PROJECTS</span>
    //     </p>
    //     <p className="text-black space font-normal text-center px-4 text-base">
    ...
    //       <p className="text-black space font-bold text-[1.3rem] pt-4">
